...
- 🎨 **[Illustrated explainers](../illustrated/index.html)** (interactive, offline): [Matrices as transformations](../illustrated/2-math/matrix-transformation.html), [Dot product & projection](../illustrated/2-math/dot-product.html) (Q1), [Bayes' theorem](../illustrated/2-math/bayes-theorem.html) (Q12/Q13), [Optimizer comparison](../illustrated/2-math/optimizer-comparison.html); plus curated [eigenvectors](https://setosa.io/ev/eigenvectors-and-eigenvalues/), [PCA](https://setosa.io/ev/principal-component-analysis/) & [Seeing Theory](https://seeing-theory.brown.edu/).
...
| 2 | Linear transformations = matrices | [3B1B](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) — **Ch.3 "Linear transformations and matrices"** · 🎨 [Visualize: matrix transforms](../illustrated/2-math/matrix-transformation.html) · 📖 [MML book §2.7](https://mml-book.github.io) | 12m |
...
| 4 | Determinant | [3B1B](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) — **Ch.6 "The determinant"** · 🎨 [Visualize: det = area](../illustrated/2-math/matrix-transformation.html) · 📖 [MML book §4.1](https://mml-book.github.io) | 10m |
...
| 6 | **Dot/inner products & orthogonality** (exam Q1) | [3B1B](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) — **Ch.9 "Dot products and duality"** · 🎨 [Visualize: dot product](../illustrated/2-math/dot-product.html) + [MML book](https://mml-book.github.io) **§3.1–3.3** | 45m |
...
| 23 | **Bayes' theorem** (exam Q12, Q13) | [StatQuest](https://www.youtube.com/@statquest) — **"Bayes' Theorem, Clearly Explained!!!!"** · 🎨 [Visualize: Bayes update](../illustrated/2-math/bayes-theorem.html) + [MML book](https://mml-book.github.io) **§6.3** | 30m |
