...
- 🎨 **ReAct agent loop** — [react-agent.html](react-agent.html) · ties to BYO-10
- 🎨 **Vector search: brute-force vs ANN** — [vector-search.html](vector-search.html) · ties to BYO-11
- 🎨 **Embeddings & cosine similarity** — [embeddings.html](embeddings.html)
